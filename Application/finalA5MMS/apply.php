...
<nav class="navbar navbar-inverse navbar-fixed-top" id="navBar">
  ...
  <div class="container col-lg-12 col-xs-12" id="header">
    <br/><br/><br/><br/><br/><br/><h1>APPLICATION FORM</h1>
  </div>

<form class="form-horizontal" action="apply.php" method="POST" enctype="multipart/form-data">
  <div class="col-lg-10 col-lg-offset-1 col-xs-12">
    <div class="panel panel-default">
      <div class="panel-heading" style="background-color:lightblue;">
        <h2 style="text-align:center;font-family:book antiqua;">Personal Information</h2>
      </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Educational Background</h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Employment History</h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Skills Best Qualified by Experience & Training  </h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Family Background</h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Reference Persons </h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Person Notified in case of Emergency</h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Others</h2>
    </div>
    ...
    <div class="panel panel-body">
      <p class="col-lg-4 col-xs-12">
        ...
        <p class="col-lg-8 col-lg-offset-2 col-xs-12">
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Government Related</h2>
    </div>
...
<div class="col-lg-10 col-lg-offset-1 col-xs-12">
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:lightblue;">
      <h2 style="text-align:center;font-family:book antiqua;">Account</h2>
    </div>
...
<div class="col-xs-12">
  <br/>
  <button type="submit" class="btn btn-success col-lg-2 col-lg-offset-5 col-xs-12" name="addBtn">
